...
$.ajax({
    url: '/orders/last-week', // Ensure this URL matches the route defined in your Laravel routes file
    method: 'GET',
    success: function(response) {
        // Once data is successfully fetched, populate the chart
        // var options = {
        //     series: [{
        //         name: 'Pending',
        //         data: response.map(item => item.total) // Assuming response contains an array of objects with 'total' property
        //     }],
        //     // Other chart options...
        // };
