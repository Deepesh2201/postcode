    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-1 gap-5 mb-5 xl:grid-cols-2">
                            ...
                            <div class="ltr:md:text-end rtl:md:text-start">
                                <button type="button" onclick="newrecord();" data-modal-target="showModal"
                                    ...
                                    data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i
                                        class="align-bottom ri-add-line me-1"></i> Add Vehicle</button>
                            </div>
                        </div>
                                ...
                                <thead class="bg-slate-100 dark:bg-zink-600">
                                    <tr>
                                        ...
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                            data-sort="id">Id</th>
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                            data-sort="country_name">Vehicle Name</th>
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                            data-sort="country_name">Vehicle Size</th>
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                            data-sort="country_name">Vehicle Capacity</th>
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                            data-sort="country_name">Description</th>
                                        {{-- <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right" data-sort="country_name">Vehicle Image</th> --}}
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                    ...
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td
                                                class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">
                                                {{ $item->description }}</td>
                                            {{-- <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">{{$item->image}}</td>     --}}
                                            ...
                                            @else
                                                <td
                                                    class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 status">
                                                    <span
                                                        class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-red-100 border-transparent text-red-500 dark:bg-green-500/20 dark:border-transparent text-uppercase">Inactive</span>
                                                </td>
                                            @endif
                                            <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                <div class="flex gap-2">
                                                    <div class="edit">
                                                        <button data-modal-target="showModal" onclick="editrecord('{{$item->id}}')"
                                                    ...
                                                    <div class="remove">
                                                        <a href="vehicledelete/{{ $item->id }}"> <button
                                                                data-modal-target="deleteRecordModal" id="delete-record"
        ...
        <div id="showModal" modal-center
            ...
            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                ...
                <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                    <form class="tablelist-form" action="{{ url('admin/vehiclesave') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3 flex justify-between">
                            <div class="w-[30%]"> <!-- Adjust width as needed -->
                                <label for="customername-field" class="inline-block mb-2 text-base font-medium">Vehicle
        ...
        <script>
            function newrecord() {
                ...
                document.getElementById('exampleModalLabel').innerHTML = 'Add New Vehicle';
            ...
            function editrecord(id) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        document.getElementById('exampleModalLabel').innerHTML = 'Update Vehicle';
