...
@section('main-section')
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <div
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                    <div class="grow">
                        <h5 class="text-16">Parcel Type</h5>
                    </div>
                            ...
                            <div class="ltr:md:text-end rtl:md:text-start">
                                <button type="button" onclick="newrecord();" data-modal-target="showModal"
                                    ...
                                    data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i
                                        class="align-bottom ri-add-line me-1"></i> Add Parcel Type</button>
                            </div>
                        </div>
                                ...
                                <thead class="bg-slate-100 dark:bg-zink-600">
                                    <tr>
                                        ...
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                            data-sort="id">Id</th>
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                            data-sort="country_name">Label</th>
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                            data-sort="country_name">Value</th>
                                        <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                <div class="flex gap-2">
                                                    ...
                                                    <div class="remove">
                                                        <a href="staticdatadelete/{{ $item->id }}"> <button
        ...
        <div id="showModal" modal-center
            ...
            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                <div class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zink-500">
                    <h5 class="text-16" id="exampleModalLabel">Add Parcel Type</h5>
                ...
                <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                    <form class="tablelist-form" action="{{ url('admin/staticdatasave') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3 flex justify-between">
                            <div class="w-[100%]"> <!-- Adjust width as needed -->
                                <label for="customername-field" class="inline-block mb-2 text-base font-medium">Label<span
                            ...
                            <div class="w-[30%]"> <!-- Adjust width as needed -->
                                <input type="hidden" value="parcel_type"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    id="type" name="type">
                            </div>
        ...
        <script>
            function newrecord() {
                document.getElementById('exampleModalLabel').innerHTML = 'Add New Parcel Type';
        ...
        <script>
            function editrecord(id) {
                $.ajax({
                    url: 'editParcelTypeWeb/' +
                        id, // Ensure this URL matches the route defined in your Laravel routes file
                    method: 'GET',
                    success: function(response) {
                        console.log(response);

                        document.getElementById('exampleModalLabel').innerHTML = 'Update Parcel Type';
