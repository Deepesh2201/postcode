...
class VehicleController extends Controller
{
    ...
    {
        $data = $request->all();
         // Serialize the city_ids array before storing it
        // $data['city_ids'] = json_encode($request->city_ids);
        // dd($data);
        // if( request('id') != null ) {
        ...
        return redirect()->to(url('admin/vehicle'));
    }
    public function editVehicleWeb($id){
